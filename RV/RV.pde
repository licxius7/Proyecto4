...
void draw() {
 ...
 pushMatrix();
  translate(219, -8, 27);
  spotLight(16, 90, 70, 80, 51, 121, 14, -23, -71, PI/2, 2);
  directionalLight(30, 50, 90, -46, 79, 54);
  ambientLight(20, 12, 20, 227, 82, 77);
  popMatrix();
  // **************FIN de LUCES******************* // 
